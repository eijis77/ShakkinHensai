...
class SubmitButton : UIView {
    ...
    private func setup(){
        ...
        labelView.text = "借金を計算する"
        labelView.textColor = UIColor.white
        labelView.backgroundColor = UIColor.hex(string: "#ff7e67", alpha: 1)
...
class CancelButton : UIView {
    ...
    private func setup(){
        ...
        labelView.textColor = UIColor.hex(string: "#ff7e67", alpha: 1)
        labelView.backgroundColor = UIColor.hex(string: "#ffffff", alpha: 1)
        labelView.layer.cornerRadius = 10
        labelView.layer.borderWidth = 3
        labelView.layer.borderColor = UIColor.hex(string: "#ff7e67", alpha: 1).cgColor
        labelView.clipsToBounds = true
        labelView.textAlignment = NSTextAlignment.center
